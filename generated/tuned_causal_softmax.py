...
# Tuning context: B=1, H=4, Sq=Sk=1024, D=Dv=64, dtype=float32, device=cpu, threads=8.
# Measured best: tile_q=256, tile_k=1024, median_latency_ms=7.122617.
# Input shapes remain dynamic; this schedule was measured best only for the context above.
